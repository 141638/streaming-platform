...
// PBAC-COMMON-CANDIDATE (jwtDecoder bean + StreamAuthenticationEntryPoint) — extract to pbac-common in Phase 6.2
...
@Configuration
@EnableConfigurationProperties({JwtProperties.class, PublishTokenProperties.class})
    ...
    public SecurityWebFilterChain springSecurity(ServerHttpSecurity http, ReactiveJwtDecoder decoder) {
        return http
                ...
                .oauth2ResourceServer(oauth2 -> oauth2
                        ...
                        .authenticationEntryPoint(new StreamAuthenticationEntryPoint())
                )
                .build();
    }
