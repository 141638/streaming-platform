...
| [0005](0005-stream-thumbnails.md) | Stream Thumbnails via SRS Auto-Snapshot (MinIO upload deferred) | Proposed |
| [0007](0007-public-channel-read-and-channel-service-seam.md) | Authenticated Channel Read in Stream-Service, with a channel-service Extraction Seam | Proposed |
