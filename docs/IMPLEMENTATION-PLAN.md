...
**Last updated:** 2026-07-16 (notification 5.1b implementation)
**Current phase:** 5 — Notifications (foundation ✅, SSE ✅, subscription+dispatcher+outbox ✅) + 6 — Production Hardening (outbox ✅) + 4 — Viewer Experience (browse/watch/HLS ✅; presence deferred) + 2 — Stream Lifecycle (2.9 thumbnails ✅)
**Active blueprint:** Phase 5 — notification 5.1b implemented (uncommitted); 5.2b fan-out deferred
